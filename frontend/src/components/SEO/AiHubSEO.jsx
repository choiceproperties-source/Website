...
const AiHubSEO = () => {
  return (
    <Helmet>
      <title>AI Property Hub | Choice Properties - Market Trends & Property Analysis</title>
      <meta name="description" content="Use Choice Properties's AI Property Hub to analyze real estate trends, compare property values, and get location-specific investment insights powered by advanced AI." />
      ...
      <meta property="og:title" content="AI Property Hub | Choice Properties" />
      ...
      <meta property="og:url" content="/ai-property-hub" />
