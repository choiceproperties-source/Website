...
export const updateAppointmentStatus = async (req, res) => {
  try {
    ...
    const mailOptions = {
      ...
      subject: `Viewing Appointment ${status.charAt(0).toUpperCase() + status.slice(1)} - Choice Properties`,
...
export const scheduleViewing = async (req, res) => {
  try {
    ...
    const mailOptions = {
      from: process.env.EMAIL,
      to: req.user.email,
      subject: "Viewing Scheduled - Choice Properties",
...
export const cancelAppointment = async (req, res) => {
  try {
    ...
    const mailOptions = {
      from: process.env.EMAIL,
      to: appointment.userId.email,
      subject: 'Appointment Cancelled - Choice Properties',
      html: `
...
export const updateAppointmentMeetingLink = async (req, res) => {
  try {
    ...
    const mailOptions = {
      from: process.env.EMAIL,
      to: appointment.userId.email,
      subject: "Meeting Link Updated - Choice Properties",
      html: `
